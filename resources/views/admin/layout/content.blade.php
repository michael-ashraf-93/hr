                                ...
                                <ul class="m-widget27__nav-items nav nav-pills nav-fill" role="tablist">
                                    <li class="m-widget27__nav-item nav-item">
                                        <a class="nav-link active" data-toggle="pill"
                                           href="admin/#m_personal_income_quater_1">
                                            Quater 1
                                        </a>
                                    </li>
                                    <li class="m-widget27__nav-item nav-item">
                                        <a class="nav-link" data-toggle="pill"
                                           href="admin/#m_personal_income_quater_2">
                                            Quater 2
                                        </a>
                                    </li>
                                    <li class="m-widget27__nav-item nav-item">
                                        <a class="nav-link" data-toggle="pill"
                                           href="admin/#m_personal_income_quater_3">
                                            Quater 3
                                        </a>
                                    </li>
                                    <li class="m-widget27__nav-item nav-item">
                                        <a class="nav-link" data-toggle="pill"
                                           href="admin/#m_personal_income_quater_4">
                                            Quater 4
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="m-widget28__container">
                                ...
                                <ul class="m-widget28__nav-items nav nav-pills nav-fill" role="tablist">
                                    <li class="m-widget28__nav-item nav-item">
                                        <a class="nav-link active" data-toggle="pill" href="admin/#menu11">
															<span>
                                    ...
                                    <li class="m-widget28__nav-item nav-item">
                                        <a class="nav-link" data-toggle="pill" href="admin/#menu21">
															<span>
                                    ...
                                    <li class="m-widget28__nav-item nav-item">
                                        <a class="nav-link" data-toggle="pill" href="admin/#menu31">
															<span>
                            ...
                            <ul class="nav nav-pills nav-pills--brand m-nav-pills--align-right m-nav-pills--btn-pill m-nav-pills--btn-sm"
                                ...
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link active" data-toggle="tab"
                                       href="admin/#m_widget2_tab1_content" role="tab">
                                        Today
                                    </a>
                                </li>
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link" data-toggle="tab"
                                       href="admin/#m_widget2_tab2_content1" role="tab">
                                        Week
                                    </a>
                                </li>
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link" data-toggle="tab"
                                       href="admin/#m_widget2_tab3_content1" role="tab">
                                        Month
                                    </a>
                                </li>
                            </ul>
                                    ...
                                    <div class="m-widget2__item m-widget2__item--primary">
                                        ...
                                        <div class="m-widget2__desc">
                                            ...
                                            <span class="m-widget2__user-name">
																<a href="admin/#" class="m-widget2__link">
																	By Bob
																</a>
															</span>
                                        </div>
                                        <div class="m-widget2__actions">
                                            <div class="m-widget2__actions-nav">
                                                <div class="m-dropdown m-dropdown--inline m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push"
                                                     m-dropdown-toggle="hover">
                                                    <a href="admin/#" class="m-dropdown__toggle">
                            ...
                            <div class="m-timeline-2">
                                <div class="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30">
                                    ...
                                    <div class="m-timeline-2__item m--margin-top-30">
                                        ...
                                        <div class="m-timeline-2__item-text m--padding-top-5">
                                            Make Deposit
                                            <a href="admin/#" class="m-link m-link--brand m--font-bolder">
                                                USD 700
                                            </a>
                                            To ESL.
                                        </div>
                    ...
                    <div class="m-portlet__head">
                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="nav nav-pills nav-pills--brand m-nav-pills--align-right m-nav-pills--btn-pill m-nav-pills--btn-sm"
                                ...
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link" data-toggle="tab"
                                       href="admin/#m_widget2_tab2_content" role="tab">
                                        Month
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="m-portlet__head">
                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="nav nav-pills nav-pills--brand m-nav-pills--align-right m-nav-pills--btn-pill m-nav-pills--btn-sm"
                                ...
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link active" data-toggle="tab"
                                       href="admin/#m_widget4_tab1_content" role="tab">
                                        Today
                                    </a>
                                </li>
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link" data-toggle="tab"
                                       href="admin/#m_widget4_tab2_content" role="tab">
                                        Week
                                    </a>
                                </li>
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link" data-toggle="tab"
                                       href="admin/#m_widget4_tab3_content" role="tab">
                                        Month
                                    </a>
                                </li>
                            </ul>
                                ...
                                <div class="m-scrollable" data-scrollable="true" data-max-height="400"
                                    ...
                                    <div class="m-list-timeline m-list-timeline--skin-light">
                                        <div class="m-list-timeline__items">
                                            ...
                                            <div class="m-list-timeline__item">
                                                <span class="m-list-timeline__badge m-list-timeline__badge--success"></span>
                                                <span href="admin/" class="m-list-timeline__text">
																	New order received
                    ...
                    <div class="m-portlet__head">
                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="nav nav-pills nav-pills--brand m-nav-pills--align-right m-nav-pills--btn-pill m-nav-pills--btn-sm"
                                ...
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link active" data-toggle="tab"
                                       href="admin/#m_widget5_tab1_content" role="tab">
                                        Last Month
                                    </a>
                                </li>
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link" data-toggle="tab"
                                       href="admin/#m_widget5_tab2_content" role="tab">
                                        last Year
                                    </a>
                                </li>
                                <li class="nav-item m-tabs__item">
                                    <a class="nav-link m-tabs__link" data-toggle="tab"
                                       href="admin/#m_widget5_tab3_content" role="tab">
                                        All time
                                    </a>
                                </li>
                            </ul>
