            ...
            <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
                ...
                <ul class="m-menu__subnav">
                    <li class="m-menu__item " aria-haspopup="true">
                        <a href="{{ url('/adduser') }}" class="m-menu__link ">
                    ...
                    <li class="m-menu__item " aria-haspopup="true">
                        <a href="{{ url('/adduser') }}" class="m-menu__link ">
                            <i class="m-menu__link-icon flaticon-file"></i>
                            <span class="m-menu__link-text"> Add Department </span>
                        </a>
                    </li>
                    ...
                    <li class="m-menu__item " aria-haspopup="true">
                        <a href="#" class="m-menu__link " data-toggle="modal" data-target="#addJob">
                            <i class="m-menu__link-icon flaticon-file"></i>
                            <span class="m-menu__link-text"> Add Job </span>
                        </a>
                    </li>

                    <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true" data-toggle="modal" data-target="#addUser">
                        <a href="#" class="m-menu__link ">
                            <i class="m-menu__link-icon flaticon-users"></i>
                            <span class="m-menu__link-text"> Add Employee
                            </span>
                        </a>
                    </li>
                </ul>
...
m-nav__item m-dropdown m-dropdown--large m-dropdown--arrow m-dropdown--align-center m-dropdown--mobile-full-width m-dropdown--skin-light	m-list-search m-list-search--skin-light"
                ...
                <a href="admin/#" class="m-nav__link m-dropdown__toggle">
                ...
                <div class="m-dropdown__wrapper">
                    ...
                    <div class="m-dropdown__inner">
                        <div class="m-dropdown__header m--align-center"
                             style="background: url(admin/assets/app/media/img/misc/notification_bg.jpg); background-size: cover;">
...
<i class="flaticon-share"></i>
                ...
                <div class="m-dropdown__wrapper">
                    ...
                    <div class="m-dropdown__inner">
                        <div class="m-dropdown__header m--align-center"
                             style="background: url(admin/assets/app/media/img/misc/quick_actions_bg.jpg); background-size: cover;">
<span class="m-dropdown__header-title">
Quick Actions
</span>
                            <span class="m-dropdown__header-subtitle">
...
Completed Tasks
            ...
            <a style="width: 84px; padding-left: auto; padding-right: auto; padding-left: 0px; padding-right: 0px;"
               href="/logout"
