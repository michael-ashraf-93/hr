<nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link" data-widget="pushmenu" href="#"><span class="badge badge-dark">Menu <i class="fa fa-bars"></i></span></i></a>
        </li>
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link"  data-toggle="modal" data-target="#add-new-task"><span class="badge badge-dark">Add New Task <i class="fa fa-calendar-plus-o"></i></span></a>
        </li>
    </ul>
