		...
		<div class="m-grid__item m-grid__item--fluid m-login__wrapper">
			<div class="m-login__container">
				...
				<div class="m-login__signin">
					...
					<form class="m-login__form m-form" method="POST" action="/check">
				...
				<div class="m-login__signup">
					...
					<form class="m-login__form m-form" method="POST" action="/store">
						{{ csrf_field() }}
						<div class="form-group m-form__group">
							<input class="form-control m-input" type="text" placeholder="First Name" name="fname" id="fname">
						</div>

						<div class="form-group m-form__group">
							<input class="form-control m-input" type="text" placeholder="Last Name" name="lname" id="lname">
						</div>
						...
						{{--<div class="form-group m-form__group">--}}
							{{--<input class="form-control m-input m-login__form-input--last" type="password" placeholder="Confirm Password" name="password_confirmation" id="password_confirmation">--}}
						{{--</div>--}}
						...
						{{--</div>--}}
						<div class="m-login__form-action">
							<button type="submit" id="m_login_signup_submit" class="btn m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary">
								Sign Up
							</button>
							&nbsp;&nbsp;
